...
import { getAuth, checkAuthStatus } from '../utils/auth'; // PARTNER FIX: Added Interceptor
...
export default function Applicants() {
  ...
  const onChangeStatus = async (appId, newStatus) => {
    try {
      ...
      // 3. PARTNER FIX: Interceptor for the status update action
